      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-2 sm:p-4 bg-black/60 backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-lg max-h-[88dvh] overflow-y-auto rounded-t-3xl sm:rounded-3xl"
          >
            <GlassCard className="p-4 sm:p-6 border-2 border-emerald-500/30 shadow-glass-lg space-y-3 sm:space-y-4 rounded-t-3xl sm:rounded-3xl">
